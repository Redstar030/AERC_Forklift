...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  else if(htim_ic->Instance==TIM2)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_11|ENC1B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = M1_PWMA_Pin|M1_PWMB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  else if(htim_ic->Instance==TIM2)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_10|GPIO_PIN_11|ENC1B_Pin);
  ...
  else if(htim_ic->Instance==TIM12)
  {
    ...
    PB15     ------> TIM12_CH2
    */
    HAL_GPIO_DeInit(GPIOB, ENC4A_Pin|ENC4B_Pin);
